...
SIGNAL \MUX_2_INST|p_out[0]~0_combout\ : std_logic;
SIGNAL \sw[1]~input_o\ : std_logic;
SIGNAL \sw[5]~input_o\ : std_logic;
SIGNAL \ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\ : std_logic;
SIGNAL \sw[6]~input_o\ : std_logic;
SIGNAL \sw[2]~input_o\ : std_logic;
SIGNAL \MUX_2_INST|p_out[2]~2_combout\ : std_logic;
SIGNAL \sw[7]~input_o\ : std_logic;
SIGNAL \sw[3]~input_o\ : std_logic;
SIGNAL \ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ : std_logic;
SIGNAL \MUX_2_INST|p_out[3]~3_combout\ : std_logic;
SIGNAL \ADDER_INST|INST1|FULL_ADDER_SUM_OUTPUT~combout\ : std_logic;
SIGNAL \MUX_2_INST|p_out[1]~1_combout\ : std_logic;
SIGNAL \INST1|Mux5~0_combout\ : std_logic;
SIGNAL \MUX_1_INST|p_out[2]~3_combout\ : std_logic;
SIGNAL \MUX_1_INST|p_out[3]~4_combout\ : std_logic;
SIGNAL \MUX_1_INST|p_out[0]~0_combout\ : std_logic;
SIGNAL \MUX_1_INST|p_out[0]~1_combout\ : std_logic;
SIGNAL \MUX_1_INST|p_out[1]~2_combout\ : std_logic;
...
\MUX_2_INST|p_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_2_INST|p_out[0]~0_combout\ = \sw[0]~input_o\ $ (((\sw[4]~input_o\ & !\pb_n[2]~input_o\)))
...
PORT MAP (
	...
	combout => \MUX_2_INST|p_out[0]~0_combout\);
...
\ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[0]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\);
...
\MUX_2_INST|p_out[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_2_INST|p_out[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\ $ (\sw[6]~input_o\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \MUX_2_INST|p_out[2]~2_combout\);
...
\ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\ADDER_INST|INST1|FULL_ADDER_CARRY_OUTPUT~0_combout\ & (\sw[6]~input_o\ & \sw[2]~input_o\))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\);

-- Location: LCCOMB_X9_Y7_N0
\MUX_2_INST|p_out[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_2_INST|p_out[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\)))))
...
PORT MAP (
	...
	datab => \pb_n[2]~input_o\,
	datac => \sw[3]~input_o\,
	datad => \ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	combout => \MUX_2_INST|p_out[3]~3_combout\);

-- Location: LCCOMB_X9_Y7_N22
\ADDER_INST|INST1|FULL_ADDER_SUM_OUTPUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \ADDER_INST|INST1|FULL_ADDER_SUM_OUTPUT~combout\ = \sw[1]~input_o\ $ (\sw[5]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \ADDER_INST|INST1|FULL_ADDER_SUM_OUTPUT~combout\);

-- Location: LCCOMB_X9_Y7_N28
\MUX_2_INST|p_out[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_2_INST|p_out[1]~1_combout\ = (\pb_n[2]~input_o\ & ((\sw[1]~input_o\))) # (!\pb_n[2]~input_o\ & (\ADDER_INST|INST1|FULL_ADDER_SUM_OUTPUT~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \ADDER_INST|INST1|FULL_ADDER_SUM_OUTPUT~combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	combout => \MUX_2_INST|p_out[1]~1_combout\);

-- Location: LCCOMB_X11_Y7_N2
\INST1|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST1|Mux5~0_combout\ = (\MUX_2_INST|p_out[3]~3_combout\ & ((\MUX_2_INST|p_out[0]~0_combout\ & ((\MUX_2_INST|p_out[1]~1_combout\))) # (!\MUX_2_INST|p_out[0]~0_combout\ & (\MUX_2_INST|p_out[2]~2_combout\)))) # (!\MUX_2_INST|p_out[3]~3_combout\ & 
-- (\MUX_2_INST|p_out[2]~2_combout\ & (\MUX_2_INST|p_out[0]~0_combout\ $ (\MUX_2_INST|p_out[1]~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \MUX_2_INST|p_out[0]~0_combout\,
	datab => \MUX_2_INST|p_out[2]~2_combout\,
	datac => \MUX_2_INST|p_out[3]~3_combout\,
	datad => \MUX_2_INST|p_out[1]~1_combout\,
	combout => \INST1|Mux5~0_combout\);

-- Location: LCCOMB_X9_Y7_N8
\MUX_1_INST|p_out[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_1_INST|p_out[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \MUX_1_INST|p_out[2]~3_combout\);

-- Location: LCCOMB_X9_Y7_N6
\MUX_1_INST|p_out[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_1_INST|p_out[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[7]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \MUX_1_INST|p_out[3]~4_combout\);

-- Location: LCCOMB_X9_Y7_N2
\MUX_1_INST|p_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_1_INST|p_out[0]~0_combout\ = (\sw[7]~input_o\ & ((\sw[3]~input_o\) # (\ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))) # (!\sw[7]~input_o\ & (\sw[3]~input_o\ & \ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\))
...
PORT MAP (
	...
	datac => \sw[3]~input_o\,
	datad => \ADDER_INST|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	combout => \MUX_1_INST|p_out[0]~0_combout\);

-- Location: LCCOMB_X9_Y7_N16
\MUX_1_INST|p_out[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_1_INST|p_out[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\MUX_1_INST|p_out[0]~0_combout\)))
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datac => \sw[4]~input_o\,
	datad => \MUX_1_INST|p_out[0]~0_combout\,
	combout => \MUX_1_INST|p_out[0]~1_combout\);

-- Location: LCCOMB_X9_Y7_N14
\MUX_1_INST|p_out[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \MUX_1_INST|p_out[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \MUX_1_INST|p_out[1]~2_combout\);

-- Location: LCCOMB_X10_Y7_N4
\INST2|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST2|Mux5~0_combout\ = (\MUX_1_INST|p_out[3]~4_combout\ & ((\MUX_1_INST|p_out[0]~1_combout\ & ((\MUX_1_INST|p_out[1]~2_combout\))) # (!\MUX_1_INST|p_out[0]~1_combout\ & (\MUX_1_INST|p_out[2]~3_combout\)))) # (!\MUX_1_INST|p_out[3]~4_combout\ & 
-- (\MUX_1_INST|p_out[2]~3_combout\ & (\MUX_1_INST|p_out[0]~1_combout\ $ (\MUX_1_INST|p_out[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \MUX_1_INST|p_out[2]~3_combout\,
	datab => \MUX_1_INST|p_out[3]~4_combout\,
	datac => \MUX_1_INST|p_out[0]~1_combout\,
	datad => \MUX_1_INST|p_out[1]~2_combout\,
...
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\MUX_2_INST|p_out[2]~2_combout\ & ((\MUX_2_INST|p_out[1]~1_combout\ & (\MUX_2_INST|p_out[0]~0_combout\ & !\MUX_2_INST|p_out[3]~3_combout\)) # (!\MUX_2_INST|p_out[1]~1_combout\ & ((\MUX_2_INST|p_out[3]~3_combout\))))) # 
-- (!\MUX_2_INST|p_out[2]~2_combout\ & (!\MUX_2_INST|p_out[3]~3_combout\ & ((\MUX_2_INST|p_out[0]~0_combout\) # (\MUX_2_INST|p_out[1]~1_combout\))))
...
PORT MAP (
	dataa => \MUX_2_INST|p_out[0]~0_combout\,
	datab => \MUX_2_INST|p_out[2]~2_combout\,
	datac => \MUX_2_INST|p_out[1]~1_combout\,
	datad => \MUX_2_INST|p_out[3]~3_combout\,
	combout => \INST1|Mux1~0_combout\);

-- Location: LCCOMB_X10_Y7_N30
\INST2|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST2|Mux1~0_combout\ = (\MUX_1_INST|p_out[2]~3_combout\ & ((\MUX_1_INST|p_out[3]~4_combout\ & ((!\MUX_1_INST|p_out[1]~2_combout\))) # (!\MUX_1_INST|p_out[3]~4_combout\ & (\MUX_1_INST|p_out[0]~1_combout\ & \MUX_1_INST|p_out[1]~2_combout\)))) # 
-- (!\MUX_1_INST|p_out[2]~3_combout\ & (!\MUX_1_INST|p_out[3]~4_combout\ & ((\MUX_1_INST|p_out[0]~1_combout\) # (\MUX_1_INST|p_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux0~0_combout\ = (\MUX_2_INST|p_out[3]~3_combout\) # ((\MUX_2_INST|p_out[2]~2_combout\ & ((!\MUX_2_INST|p_out[1]~1_combout\) # (!\MUX_2_INST|p_out[0]~0_combout\))) # (!\MUX_2_INST|p_out[2]~2_combout\ & ((\MUX_2_INST|p_out[1]~1_combout\))))
...
-- Equation(s):
-- \INST2|Mux0~0_combout\ = (\MUX_1_INST|p_out[3]~4_combout\) # ((\MUX_1_INST|p_out[2]~3_combout\ & ((!\MUX_1_INST|p_out[1]~2_combout\) # (!\MUX_1_INST|p_out[0]~1_combout\))) # (!\MUX_1_INST|p_out[2]~3_combout\ & ((\MUX_1_INST|p_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux6~0_combout\ = (\MUX_2_INST|p_out[2]~2_combout\ & (!\MUX_2_INST|p_out[1]~1_combout\ & ((\MUX_2_INST|p_out[3]~3_combout\) # (!\MUX_2_INST|p_out[0]~0_combout\)))) # (!\MUX_2_INST|p_out[2]~2_combout\ & (\MUX_2_INST|p_out[0]~0_combout\ & 
-- (\MUX_2_INST|p_out[1]~1_combout\ $ (!\MUX_2_INST|p_out[3]~3_combout\))))
...
-- Equation(s):
-- \INST2|Mux6~0_combout\ = (\MUX_1_INST|p_out[2]~3_combout\ & (!\MUX_1_INST|p_out[1]~2_combout\ & ((\MUX_1_INST|p_out[3]~4_combout\) # (!\MUX_1_INST|p_out[0]~1_combout\)))) # (!\MUX_1_INST|p_out[2]~3_combout\ & (\MUX_1_INST|p_out[0]~1_combout\ & 
-- (\MUX_1_INST|p_out[3]~4_combout\ $ (!\MUX_1_INST|p_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux4~0_combout\ = (\MUX_2_INST|p_out[2]~2_combout\ & (\MUX_2_INST|p_out[3]~3_combout\ & ((\MUX_2_INST|p_out[1]~1_combout\) # (!\MUX_2_INST|p_out[0]~0_combout\)))) # (!\MUX_2_INST|p_out[2]~2_combout\ & (!\MUX_2_INST|p_out[0]~0_combout\ & 
-- (\MUX_2_INST|p_out[1]~1_combout\ & !\MUX_2_INST|p_out[3]~3_combout\)))
...
-- Equation(s):
-- \INST2|Mux4~0_combout\ = (\MUX_1_INST|p_out[2]~3_combout\ & (\MUX_1_INST|p_out[3]~4_combout\ & ((\MUX_1_INST|p_out[1]~2_combout\) # (!\MUX_1_INST|p_out[0]~1_combout\)))) # (!\MUX_1_INST|p_out[2]~3_combout\ & (!\MUX_1_INST|p_out[3]~4_combout\ & 
-- (!\MUX_1_INST|p_out[0]~1_combout\ & \MUX_1_INST|p_out[1]~2_combout\)))
...
-- Equation(s):
-- \INST2|Mux3~0_combout\ = (\MUX_1_INST|p_out[1]~2_combout\ & ((\MUX_1_INST|p_out[2]~3_combout\ & ((\MUX_1_INST|p_out[0]~1_combout\))) # (!\MUX_1_INST|p_out[2]~3_combout\ & (\MUX_1_INST|p_out[3]~4_combout\ & !\MUX_1_INST|p_out[0]~1_combout\)))) # 
-- (!\MUX_1_INST|p_out[1]~2_combout\ & (!\MUX_1_INST|p_out[3]~4_combout\ & (\MUX_1_INST|p_out[2]~3_combout\ $ (\MUX_1_INST|p_out[0]~1_combout\))))
...
-- Equation(s):
-- \INST1|Mux3~0_combout\ = (\MUX_2_INST|p_out[1]~1_combout\ & ((\MUX_2_INST|p_out[0]~0_combout\ & (\MUX_2_INST|p_out[2]~2_combout\)) # (!\MUX_2_INST|p_out[0]~0_combout\ & (!\MUX_2_INST|p_out[2]~2_combout\ & \MUX_2_INST|p_out[3]~3_combout\)))) # 
-- (!\MUX_2_INST|p_out[1]~1_combout\ & (!\MUX_2_INST|p_out[3]~3_combout\ & (\MUX_2_INST|p_out[0]~0_combout\ $ (\MUX_2_INST|p_out[2]~2_combout\))))
...
-- Equation(s):
-- \INST2|Mux2~0_combout\ = (\MUX_1_INST|p_out[1]~2_combout\ & (((!\MUX_1_INST|p_out[3]~4_combout\ & \MUX_1_INST|p_out[0]~1_combout\)))) # (!\MUX_1_INST|p_out[1]~2_combout\ & ((\MUX_1_INST|p_out[2]~3_combout\ & (!\MUX_1_INST|p_out[3]~4_combout\)) # 
-- (!\MUX_1_INST|p_out[2]~3_combout\ & ((\MUX_1_INST|p_out[0]~1_combout\)))))
...
-- Equation(s):
-- \INST1|Mux2~0_combout\ = (\MUX_2_INST|p_out[1]~1_combout\ & (\MUX_2_INST|p_out[0]~0_combout\ & ((!\MUX_2_INST|p_out[3]~3_combout\)))) # (!\MUX_2_INST|p_out[1]~1_combout\ & ((\MUX_2_INST|p_out[2]~2_combout\ & ((!\MUX_2_INST|p_out[3]~3_combout\))) # 
-- (!\MUX_2_INST|p_out[2]~2_combout\ & (\MUX_2_INST|p_out[0]~0_combout\))))
